...
api_url="https://api.github.com/repos/phrase/phrase-kotlin/releases?access_token=${GITHUB_TOKEN}"
...
asset="https://uploads.github.com/repos/phrase/phrase-kotlin/releases/${release_id}/assets?name=$(basename "$file")&access_token=${GITHUB_TOKEN}"
