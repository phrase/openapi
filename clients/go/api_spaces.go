 ...
 * @param "XPhraseAppOTP" (optional.String) -  Two-Factor-Authentication token
@return Space
*/
func (a *SpacesApiService) Space(ctx _context.Context, accountId string, spaceId string, localVarOptionals *SpaceOpts) (Space, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/accounts/{account_id}/spaces/{space_id}"
...
@return Space
*/
func (a *SpacesApiService) SpaceCreate(ctx _context.Context, accountId string, inlineObject InlineObject, localVarOptionals *SpaceCreateOpts) (Space, *_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/accounts/{account_id}/spaces"
	localVarPath = strings.Replace(localVarPath, "{"+"account_id"+"}", _neturl.QueryEscape(parameterToString(accountId, "")) , -1)
 ...
 * @param "XPhraseAppOTP" (optional.String) -  Two-Factor-Authentication token
*/
func (a *SpacesApiService) SpaceDelete(ctx _context.Context, accountId string, spaceId string, localVarOptionals *SpaceDeleteOpts) (*_nethttp.Response, error) {
	var (
...
// SpaceProjectDeleteOpts Optional parameters for the method 'SpaceProjectDelete'
type SpaceProjectDeleteOpts struct {
    XPhraseAppOTP optional.String
}

/*
SpaceProjectDelete Removes a specified project from the specified space.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId Account ID
 * @param spaceId Space ID
 * @param projectId Project ID
 * @param optional nil or *SpaceProjectDeleteOpts - Optional Parameters:
 * @param "XPhraseAppOTP" (optional.String) -  Two-Factor-Authentication token
*/
func (a *SpacesApiService) SpaceProjectDelete(ctx _context.Context, accountId string, spaceId string, projectId string, localVarOptionals *SpaceProjectDeleteOpts) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodDelete
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/accounts/{account_id}/spaces/{space_id}/projects/{project_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"account_id"+"}", _neturl.QueryEscape(parameterToString(accountId, "")) , -1)
...
// SpaceProjectsOpts Optional parameters for the method 'SpaceProjects'
type SpaceProjectsOpts struct {
    XPhraseAppOTP optional.String
    Page optional.Int32
...
/*
SpaceProjects List all projects for the specified Space..
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId Account ID
 * @param spaceId Space ID
 * @param optional nil or *SpaceProjectsOpts - Optional Parameters:
 * @param "XPhraseAppOTP" (optional.String) -  Two-Factor-Authentication token
 * @param "Page" (optional.Int32) -  Page number
 * @param "PerPage" (optional.Int32) -  allows you to specify a page size up to 100 items, 10 by default
@return []Project
*/
func (a *SpacesApiService) SpaceProjects(ctx _context.Context, accountId string, spaceId string, localVarOptionals *SpaceProjectsOpts) ([]Project, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/accounts/{account_id}/spaces/{space_id}/projects"
	localVarPath = strings.Replace(localVarPath, "{"+"account_id"+"}", _neturl.QueryEscape(parameterToString(accountId, "")) , -1)
...
// SpaceProjectsCreateOpts Optional parameters for the method 'SpaceProjectsCreate'
type SpaceProjectsCreateOpts struct {
    XPhraseAppOTP optional.String
}

/*
SpaceProjectsCreate Adds an existing project to the space.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId Account ID
 * @param spaceId Space ID
 * @param inlineObject2
 * @param optional nil or *SpaceProjectsCreateOpts - Optional Parameters:
 * @param "XPhraseAppOTP" (optional.String) -  Two-Factor-Authentication token
@return Project
*/
func (a *SpacesApiService) SpaceProjectsCreate(ctx _context.Context, accountId string, spaceId string, inlineObject2 InlineObject2, localVarOptionals *SpaceProjectsCreateOpts) (Project, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return Space
*/
func (a *SpacesApiService) SpaceUpdate(ctx _context.Context, accountId string, spaceId string, inlineObject1 InlineObject1, localVarOptionals *SpaceUpdateOpts) (Space, *_nethttp.Response, error) {
	var (
...
// SpacesOpts Optional parameters for the method 'Spaces'
...
/*
Spaces List all Spaces for the given account.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId Account ID
 * @param optional nil or *SpacesOpts - Optional Parameters:
 * @param "XPhraseAppOTP" (optional.String) -  Two-Factor-Authentication token
 * @param "Page" (optional.Int32) -  Page number
 * @param "PerPage" (optional.Int32) -  allows you to specify a page size up to 100 items, 10 by default
@return []Space
*/
func (a *SpacesApiService) Spaces(ctx _context.Context, accountId string, localVarOptionals *SpacesOpts) ([]Space, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
